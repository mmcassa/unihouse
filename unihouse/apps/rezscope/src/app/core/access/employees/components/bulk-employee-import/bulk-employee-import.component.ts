...
@Component({
  selector: 'app-bulk-employee-import',
  imports: [
    AsyncPipe,
    ReactiveFormsModule,
    TuiFiles
  ],
  templateUrl: './bulk-employee-import.component.html',
  styleUrl: './bulk-employee-import.component.scss'
})
export class BulkEmployeeImportComponent {
